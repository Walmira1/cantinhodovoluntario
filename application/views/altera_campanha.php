	...
	<div class="row clearfix">
		...
		<!-- [INI][/INI] -->
                ...
                <div class="col-md-3 column incluir_curso">
                    ...
                    <input type="text" name="video"  value ="<?php echo $campanha->video;?> " />
                </div>
                <div class="col-md-3 column incluir_curso">
                            <br />
                            Data Inclusão:
                ...
                <div class="col-md-3 column incluir_curso">
                            ...
                            <input type="date" name="data_fim" min="<?php echo date('Y-m-d');?>" required="" value ="<?php echo $campanha->data_fim;?>"  />
                </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                ...
                <div>                                                   
                        <input type="submit" class="btn btn-primary btn-lg " style="margin-top: 20px; margin-left: 75%;" value="Alterar Campanha"/>                         
                </div>
            </div>
        </div>
        </form>
