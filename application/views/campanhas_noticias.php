<div class="container">
	<div class="row clearfix">
		<div class="col-md-2 column nosso_logo">
			<a href="index.html">
				<img class="img-responsive" alt="" src="img/cantinho.png" class="logo_cantinho">
			</a>
		</div>
    ...
    <div class="col-md-12 column">  
	<div class="row clearfix mapa1">
        	<div id="mapa2">
        		<div>
        	    <h2> Aqui você encontra cursos, campanhas e noticias de Instituições cadastradas
          	   	</h2>
          	   	</div>                              
         	</div>          	
        </div>
			...
			<div class="row clearfix">
				<div class="col-md-4 column ">
					<a href="saiba_mais_campanha.html">				
						<img class="img-responsive"  src="img/união.jpg" class="foto-campanha" >
					</a>
					...
					<p class="article-paragraph ">
						Proteger e melhorar o meio ambiente é desejo urgente e dever de todos.
						E você, está fazendo sua parte?
						5 de Junho Dia Mundial do Meio Ambiente.
						Cuide bem do lugar onde você mora.
					</p>
					<span>
				...
				<div class="col-md-4 column ">	
					<a href="saiba_mais_campanha1.html">			
						<img class="img-responsive"  src="img/Dogs-and-cats.jpg" class="foto-campanha" >
					</a>
					<div class="titulo_curso">	
						<a href="saiba_mais_campanha1.html">
				...
				<div class="col-md-4 column ">	
					<a href="saiba_mais_campanha.html">			
					<img class="img-responsive"  src="img/Agasalho_02.jpg" class="foto-campanha" >
					</a>
					<div class="titulo_curso">	
						<a href="saiba_mais_campanha.html">
	...
	<div class="row clearfix">
		<div class="col-md-12 column col_paginacao">
			<div class="paginacao">
                   < 1, 2, 3, 4, 5 .... 12 >
             </div>
		</div>
		...
		<div class="col-md-12 column">
			<div id="rodape">
				...
				<div>
                    ...
                    <a href="https://www.facebook.com/pages/Cantinho-do-Volunt%C3%A1rio/793095697472047" >
                          <img class="img-responsive" src="img/Facebook_creatures.png" alt="Facebook" 
