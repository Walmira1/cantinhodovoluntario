...
<div class="container">
	...
	<div class="row clearfix">
            <div class="col-md-12 column">
		<!-- [INI][/INI] -->
                    <h2 style="margin-left: 15px;">Alterar Campanhas ou Noticias</h2>
                <div class="col-md-3 column incluir_curso">
                            <br />
                            Titulo:
                            <br />
                            <input type="text" name="titulo" required="" value ="<?php echo $campanha->titulo_campanha_noticia;?>" autofocus readonly="true"/>
                ...
                <div class="col-md-3 column incluir_curso">
                    ...
                    <input type="text" name="video"  value ="<?php echo $campanha->video;?>" readonly="true" />
                </div>
                <div class="col-md-3 column incluir_curso">
                            <br />
                            Data Inclusão:
                            ...
                            <input type="date" name="data_inclusao" min="<?php echo date('Y-m-d');?>" required="" value ="<?php echo $campanha->data_inclusao;?>" readonly="true"/>
                </div>
                <div class="col-md-3 column incluir_curso">
                            <br />
                            Data Fim:
                            ...
                            <input type="date" name="data_fim" min="<?php echo date('Y-m-d');?>" required="" value ="<?php echo $campanha->data_fim;?>" readonly="true" />
                </div>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div style="margin-left: 2%; margin-top: 15px;">
                            ...
                            class="editar">'.$campanha->descricao.'</textarea>'?>
                </div>
                <div>          
                </div>
            </div>
